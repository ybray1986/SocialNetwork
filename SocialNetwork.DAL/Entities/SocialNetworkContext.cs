    ...
    public partial class SocialNetworkContext : DbContext
    {
        ...
        public class DbContextInitializer : DropCreateDatabaseAlways<SocialNetworkContext>
        {
            protected override void Seed(SocialNetworkContext context)
            {
                ...
                context.AppUsers.Add(new Entities.AppUser { UserId = 1, FirstName = "John", LastName = "Doe", MiddleName = "", Email="user1@mail.ru", BirthDate = new DateTime(1999, 05, 10), Password="1234", RegisteredDate = new DateTime(2019, 09, 20) });
                context.AppUsers.Add(new Entities.AppUser { UserId = 2, FirstName = "Max", LastName = "Payne", MiddleName = "", BirthDate = new DateTime(1998, 01, 20), RegisteredDate = new DateTime(2019, 09, 20) });
